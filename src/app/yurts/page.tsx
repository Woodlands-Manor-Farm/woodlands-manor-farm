...
export const metadata: Metadata = {
  ...
  description:
    "Luxury glamping in Cornwall — two authentic hand-crafted Mongolian yurts at Woodlands Manor Farm near Bude. Super-king bed and two singles, high-end wood burner, private kitchen and bathroom, dogs welcome, open all year, with access to the heated indoor pool. Sleeps 4 each.",
  ...
  return (
    <ListingPage
      hero={{
        ...
        description:
          "Two authentic hand-crafted Mongolian yurts in a secluded corner of the farm by the pond, looking down over the woodland. Each sleeps four with a super-king bed and two singles, its own private kitchen and bathroom, a high-end wood burner for cosy winters, and its own BBQ and picnic bench — plus full run of the farm, including the heated indoor pool. Open all year. Dogs welcome.",
      }}
      yurts={YURT_CARDS}
