...
export const metadata: Metadata = {
  title: "Local Beaches & Walks near Bude",
  description:
    "The best beaches and walks near Woodlands Manor Farm, Bude — Duckpool, Sandymouth, Summerleaze, Welcombe Mouth, plus woodland and coastal walks, with directions from the farm.",
  ...
  return (
    <>
      <InfoHero
        ...
        description="Some of North Cornwall's finest beaches and walks are right on our doorstep — here are our favourites, with directions straight from the farm gate."
      />
