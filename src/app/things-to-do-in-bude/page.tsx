...
const ATTRACTIONS = [
  {
    ...
    href: "https://www.visitbude.info/things-to-do/the-castle-bude/",
  },
  {
    distance: "6 miles",
    name: "Bude Sea Pool",
    ...
    href: "https://www.visitbude.info/things-to-do/bude-sea-pool/",
  },
  {
    distance: "6 miles",
    name: "Teylu Glass",
    body: "A glass studio and gallery in Bude showcasing beautiful handmade glass art. A lovely place to browse unique, locally-made pieces and pick up a special gift — and a perfect rainy-day stop.",
    href: "https://www.visitbude.info/things-to-do/teylu-glass/",
  },
  {
    distance: "6 miles",
    name: "Budehaven Recreation Ground",
    body: "A large recreation ground in the heart of Bude with a skate park, play areas, sports pitches and open green space — a handy spot for the children to let off steam, right by the town and beaches.",
    href: "https://www.visitbude.info/things-to-do/budehaven-recreation-ground/",
  },
  {
    distance: "18 miles",
    ...
    href: "https://www.visitbude.info/things-to-do/cornwall-at-war-museum/",
  },
  {
    distance: "20 miles",
    name: "The Big Sheep",
    ...
    href: "https://www.visitbude.info/things-to-do/the-big-sheep/",
  },
  {
    distance: "30 miles",
