...
export const PROPERTY_CONTENT: Record<string, PropertyPageData> = {
  "the-manor-house": {
    ...
    gallery: [
      ...
      { src: "/images/the-manor-house/manor-snug.jpg", alt: "Snug sitting area with leather club armchairs and original beams" },
  ...
  "rose-cottage": {
    ...
    gallery: [
      ...
      { src: "/images/rose-cottage/rose-bedroom-pink.jpg", alt: "Double bedroom at Rose Cottage with a pink colour scheme" },
      { src: "/images/rose-cottage/rose-twin.jpg", alt: "Twin bedroom at Rose Cottage" },
      { src: "/images/rose-cottage/rose-twin-pink.jpg", alt: "Second twin bedroom at Rose Cottage with pink furnishings" },
  ...
  "the-coach-house": {
    ...
    gallery: [
      ...
      { src: "/images/the-coach-house/coach-bedroom-window.jpg", alt: "Coach House bedroom seating nook by the window" },
      { src: "/images/the-coach-house/coach-bathroom.jpg", alt: "Coach House shower room with quadrant shower" },
    ],
  ...
  "the-stables": {
    ...
    gallery: [
      ...
      { src: "/images/the-stables/stables-bathroom.jpg", alt: "The Stables master bathroom with jacuzzi bath" },
