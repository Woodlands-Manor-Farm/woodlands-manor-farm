...
const STATIC_PATHS: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
  ...
  { path: "/woodlands-history/", changeFrequency: "yearly", priority: 0.5 },
  ...
  { path: "/beaches-and-walks-near-bude/", changeFrequency: "monthly", priority: 0.6 },
  { path: "/local-towns-and-villages-near-bude/", changeFrequency: "monthly", priority: 0.6 },
